            ...
            <div className="modal-content help-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-body help-body">
                    <div className="help-section">
                        ...
                        <ul>
                            <li><strong>New project</strong> — Click &quot;New Project&quot;, choose a design style, then describe your product.</li>
                    ...
                    <div className="help-section">
                        ...
                        <ul>
                            <li><strong>Edit a section</strong> — Select it from the dropdown, then describe what to change (e.g., &quot;Make the heading bigger&quot;).</li>
                    ...
                    <div className="help-section">
                        ...
                        <ul>
                            <li><strong>&quot;Try again&quot; or &quot;Retry&quot;</strong> — Re-runs the last generation if you&apos;re not happy.</li>
